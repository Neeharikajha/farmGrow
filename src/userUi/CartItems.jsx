...
// //   const recos = [
// //     { id: "r1", name: "Fresh Coriander (Dhaniya) 100g", price: 12, image: "https://images.unsplash.com/photo-1560807707-8cc77767d783?w=400" },
// //     { id: "r2", name: "Green Chilli 250g",             price: 20, image: "https://images.unsplash.com/photo-1601004890684-d8cbf643f5f2?w=400" },
// //   ];
...
// //         <div className="rounded-xl border border-gray-200 bg-white p-3 text-[12px] text-gray-600 flex items-center gap-2">
// //           <span>🛡️</span> Buy with confidence – 100% no‑risk money‑back guarantee
// //         </div>

// //         <button className="text-xs text-red-600 hover:underline self-start">
// //           Cancel Order
// //         </button>
// //       </div>
